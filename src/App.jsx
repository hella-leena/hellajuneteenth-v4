...
const HERO_YOUTUBE_EMBED_URL = 'https://www.youtube.com/embed/_PTOes53f78?si=qE9dlGbr5gwKsEhO'

const experienceCards = [
  {
    image: '/images/20240619_JuneteenthCookout_GC-6_qed.jpg',
    title: 'The Cookout',
    byline: 'Past festival highlights from our culinary hub celebrating the depth of Black foodways.',
    imagePosition: '50% 52%',
  },
  {
    image: '/images/20240619_JuneteenthCookout_GC-16_qed-1536x1024.jpg',
    title: 'The Green',
    byline: 'Past festival photos and videos from our picnic-style community gathering space.',
    imagePosition: '50% 50%',
  },
  {
    image: '/images/DSC_8245.jpg',
    title: 'Hella Games',
    byline: 'Past festival moments from adult play spaces featuring classics like dominoes and spades.',
    imagePosition: '52% 56%',
  },
  {
    image: '/images/20250619_HELLAJUNETEENTH_GC-48-KQED.jpg',
    title: 'Hella Kids',
    byline: 'Past festival highlights from our kid zone and family-centered programming.',
    imagePosition: '50% 18%',
  },
]
...
const yesBring = [
  ...
  'Picnics and coolers (outside food and non-alcoholic beverages welcome).',
...
const neighborhoodPins = [
  { name: 'Cloud Park (Festival Site)', detail: 'Downtown Oakland', href: 'https://www.google.com/maps/search/?api=1&query=Cloud+Park+Oakland+CA' },
  { name: 'Kinfolx', detail: 'Partner spotlight', href: 'https://www.google.com/maps/search/?api=1&query=Kinfolx+Oakland+CA' },
  { name: 'Lucy Blue', detail: 'Partner spotlight', href: 'https://www.google.com/maps/search/?api=1&query=Lucy+Blue+Oakland+CA' },
]
    ...
    <footer className="footer" id="press">
      ...
      <div className="footer-links">
        <div className="footer-col">
          <a href="/#tickets" className="dashed-link flip-up"><FlipText text="Get tickets" /></a>
          <a href="#" className="dashed-link flip-up"><FlipText text="Get Involved" /></a>
          <a href="#" className="dashed-link flip-up"><FlipText text="More Events" /></a>
        </div>
        <div className="footer-col">
          <a href="/faq" className="dashed-link flip-up"><FlipText text="FAQ" /></a>
    ...
    <div className="page" id="top">
      ...
      <section className="hero-top">
        ...
        <div className="hero-info">
          <div>
            <p>June 19, 2026<br />More details coming soon</p>
          </div>
          <div>
      ...
      <section className="register-callout section-black">
        ...
        <div>
          <h2 className="dashed-heading">
            ...
            <a href="/#tickets" className="callout-ticket-link" aria-label="Get your ticket">
      ...
      <section className="highlights section-black" id="lineup">
        <div className="content-grid">
          ...
          <div>
            ...
            <p className="experience-intro">Each category below includes dedicated space for past photos/videos.</p>
            <div className="cards">
      ...
      <section className="tickets section-black" id="tickets">
        <div className="content-grid">
          ...
          <div>
            ...
            <div className="ticket-grid ticket-grid-four">
              {ticketTypes.map((ticket) => (
                <article className="ticket-card" key={ticket.title}>
                  ...
                  <a href={SIGNUP_URL} className="ticket-btn flip-up"><FlipText text={ticket.cta} /></a>
                </article>
              ))}
            </div>
            <p className="ticket-note">Ticket link placeholder: Eventbrite URL will be added once final.</p>
          </div>
        </div>
      </section>
      ...
      <section className="map-section section-black" id="map">
        <div className="content-grid">
          <div className="side-label">AROUND THE BLOCK</div>
          <div>
            <h2>Festival map + neighborhood partners</h2>
            <p className="map-intro">
              Cloud Park is our main festival location. We are also highlighting nearby Black-owned partners around the block.
            </p>
            <div className="map-layout">
              ...
              <div className="map-pins">
                {neighborhoodPins.map((pin) => (
                  <a key={pin.name} className="map-pin-card" href={pin.href} target="_blank" rel="noreferrer">
